# run_bow_supervised.py
# ==============================================================================
# Runner per BOW + Logistic Regression (Tabella 1: Supervision Helps)
# ==============================================================================
...
flags.DEFINE_string("prediction_file", "../out/PeerRead/bow_supervised/predictions.tsv", "File TSV output predizioni")
...
def main(_):
    ...
    X = np.stack(bows)  # shape (n_docs, vocab_size)
    y = np.array(outcomes)
